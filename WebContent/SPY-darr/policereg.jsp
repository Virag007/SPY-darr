...
<link rel="stylesheet" href="css/policereg.css">
...
<div id="back">
	...
	<form id="login" enctype="multipart/form-data" action="policereg.jsp">
		<table>
			...
			<tr>
				<td>Email<input type="email" name="email" placeholder="Email" value=<%= request.getParameter("sendemail2") %> style="width:230px;margin-left:110px;margin-top:10px" required></td>
			</tr>
			<tr>
				<td>Password<input type="password" name="passwd" placeholder="Password" value=<%= request.getParameter("sendpassword2") %> style="width:230px;margin-left:83px;margin-top:10px" required></td>
			</tr>
			<tr>
				<td>Confirm Password<input type="password" name="cpasswd" placeholder="Confirm Password" value=<%= request.getParameter("sendpassword2") %> style="width:230px;margin-left:25px;margin-top:10px" required></td>
			</tr>
			<tr>
