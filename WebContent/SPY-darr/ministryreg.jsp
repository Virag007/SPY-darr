...
<link rel="stylesheet" href="css/ministryreg.css">
...
<div id="back">
	...
	<form id="login" enctype="multipart/form-data" action="ministryreg.jsp">
		<table>
			...
			<tr>
				<td>Department<input type="text" name="dept" placeholder="Department Name" style="width:230px;margin-left:70px;margin-top:10px" required></td>
			</tr>
			<tr>
				<td>Email<input type="email" name="email" placeholder="Email" value=<%= request.getParameter("sendemail3") %> style="width:230px;margin-left:110px;margin-top:10px" required></td>
			</tr>
			<tr>
				<td>Password<input type="password" name="passwd" placeholder="Password" value=<%= request.getParameter("sendpassword3") %> style="width:230px;margin-left:83px;margin-top:10px" required></td>
			</tr>
			<tr>
				<td>Confirm Password<input type="password" name="cpasswd" placeholder="Confirm Password" value=<%= request.getParameter("sendpassword3") %> style="width:230px;margin-left:25px;margin-top:10px" required></td>
			</tr>
			<tr>
				<td>Phone<input type="number" name="phone" placeholder="Phone" style="width:230px;margin-left:105px;margin-top:10px" required></td>
			</tr>
			<tr>
				<td>Residential Address<textarea name="addr" placeholder="Residential Address" style="width:230px;margin-left:15px;margin-top:10px"></textarea></td>
			</tr>
			<tr>
...
String sql="INSERT INTO ministry VALUES (NULL,'"+username+"','"+email+"','"+password+"','"+phone+"','"+address+"','"+pincode+"','"+department+"')";
String sql1="INSERT INTO status VALUES (NULL,'ministry','"+username+"','"+email+"','"+password+"')";
